...
export const Hero = () => {
    return (
        <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden px-6 pt-24">
            ...
            {/* Ambient Glow */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-neon-purple/20 rounded-full blur-[150px] animate-pulse pointer-events-none" />
            ...
            <div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-2 gap-16 items-center z-20">
                <div className="space-y-8">
                    ...
                    >
                        <span className="px-4 py-2 border border-neon-cyan/20 bg-neon-cyan/5 rounded-full text-neon-cyan font-mono text-xs tracking-widest backdrop-blur-sm">
                            &lt; AVAILABLE FOR WORK /&gt;
                        </span>
                    </motion.div>
                    ...
                    >
                        <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold leading-[0.9] font-display text-white">
                            FULL STACK <br />
                    ...
                    >
                        <TextReveal className="text-gray-400 text-lg md:text-xl max-w-lg leading-relaxed font-sans" delay={1}>
                    ...
                    >
                        <MagneticButton
                            href="#projects"
                            className="group px-8 py-4 bg-white text-black font-bold font-display rounded-sm flex items-center gap-2"
                        >
                            VIEW PROJECTS
                        ...
                        <MagneticButton
                            ...
                            className="px-8 py-4 border border-white/20 text-white font-bold font-display rounded-sm hover:bg-white/5 hover:border-white/40 transition-all duration-300"
                        >
                            GITHUB
                        </MagneticButton>
                    </motion.div>
                    ...
                    >
                       ...
                       <div className="absolute inset-0 flex items-center justify-center">
                        <div className="flex items-center justify-center">
                            ...
                            alt="Profile"
                            className="w-100 h-100 rounded-full border-4 border-cyan-400 shadow-xl object-cover"
                            />
